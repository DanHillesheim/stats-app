...
export function Label({ className, ...props }) {
  return (
    <Headless.Label
      ...
      className={clsx(
        className,
        'text-base/6 text-slate-950 select-none data-disabled:opacity-50 sm:text-sm/6 dark:text-white'
      )}
    />
  )
}
...
export function Description({ className, ...props }) {
  return (
    <Headless.Description
      ...
      {...props}
      className={clsx(className, 'text-base/6 text-slate-500 data-disabled:opacity-50 sm:text-sm/6 dark:text-slate-400')}
    />
  )
}
