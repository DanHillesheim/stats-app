        ...
        <div className="grid min-h-full grid-rows-[1fr_auto] justify-items-center sm:grid-rows-[1fr_auto_3fr] sm:p-4">
          <Headless.DialogPanel
            ...
            className={clsx(
              className,
              sizes[size],
              'row-start-2 w-full min-w-0 rounded-t-3xl bg-white p-(--gutter) shadow-lg ring-1 ring-slate-950/10 [--gutter:--spacing(8)] sm:mb-auto sm:rounded-2xl dark:bg-slate-900 dark:ring-white/10 forced-colors:outline',
...
export function DialogTitle({ className, ...props }) {
  return (
    <Headless.DialogTitle
      {...props}
      className={clsx(className, 'text-lg/6 font-semibold text-balance text-slate-950 sm:text-base/6 dark:text-white')}
    />
  )
}
