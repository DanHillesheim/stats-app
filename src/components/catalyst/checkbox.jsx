...
const base = [
  ...
  // Border
  'border border-slate-950/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-slate-950/30 group-data-checked:bg-(--checkbox-checked-border)',
  ...
  'group-data-disabled:border-slate-950/25 group-data-disabled:bg-slate-950/5 group-data-disabled:[--checkbox-check:var(--color-slate-950)]/50 group-data-disabled:before:bg-transparent',
...
const colors = {
  'dark/slate': [
    '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-slate-900)] [--checkbox-checked-border:var(--color-slate-950)]/90',
    'dark:[--checkbox-checked-bg:var(--color-slate-600)]',
  ],
  'dark/white': [
    '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-slate-900)] [--checkbox-checked-border:var(--color-slate-950)]/90',
    'dark:[--checkbox-check:var(--color-slate-900)] dark:[--checkbox-checked-bg:var(--color-white)] dark:[--checkbox-checked-border:var(--color-slate-950)]/15',
  ],
  white:
    '[--checkbox-check:var(--color-slate-900)] [--checkbox-checked-bg:var(--color-white)] [--checkbox-checked-border:var(--color-slate-950)]/15',
  dark: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-slate-900)] [--checkbox-checked-border:var(--color-slate-950)]/90',
  slate: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-slate-600)] [--checkbox-checked-border:var(--color-slate-700)]/90',
