    ...
    >
      <Headless.Select
        ...
        className={clsx([
          ...
          // Disabled state
          'data-disabled:border-slate-950/20 data-disabled:opacity-100 dark:data-disabled:border-white/15 dark:data-disabled:bg-white/2.5 dark:data-hover:data-disabled:border-white/15',
        ])}
      />
      {!multiple && (
        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
          <svg
            className="size-5 stroke-slate-500 group-has-data-disabled:stroke-slate-600 sm:size-4 dark:stroke-slate-400 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
